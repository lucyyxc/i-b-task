...
const Profile = ({user, modal, cancel, getUserInfo, handleDateChangeRaw}) => {
  ...
  return (
    <div className={`modal Profile ${modal ? 'show': ''}`} onClick={e => e.stopPropagation()}>
      ...
      <p className="blurb">Here's all of your information. If anything changes, please update it by clicking the pencil in the top left corner. 
      If you need to change your email, reach out to us at <a href="mailto:contact@theindependentbride.com">contact@theindependentbride.com</a>.
      </p>
